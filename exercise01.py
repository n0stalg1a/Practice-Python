...
usernum = int(input('Please enter another number: '))
CURRENT_YEAR = 2024

for i in range(1, usernum + 1):
    print(f'{i}. Hello {username}, you are {userage} years old and you will be'
          f' 100 years old in {(CURRENT_YEAR - userage) + 100}.')
